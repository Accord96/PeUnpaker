...
#define FIRST_PROCESS(Processes) ((PSYSTEM_PROCESS_INFORMATION)(Processes))

#define NEXT_PROCESS(Process) ( \
...
#define FIRST_OBJECT_TYPE(ObjectTypes) \
    (POBJECT_TYPE_INFORMATION) (POBJECT_TYPES_INFORMATION) ObjectTypes->TypeInformation

#define NEXT_OBJECT_TYPE(ObjectType) \
...
#define SeMinWellKnownPrivilege                 (2L)
#define SeCreateTokenPrivilege                  (2L)
#define SeAssignPrimaryTokenPrivilege           (3L)
#define SeLockMemoryPrivilege                   (4L)
#define SeIncreaseQuotaPrivilege                (5L)

#define SeMachineAccountPrivilege               (6L)
#define SeTcbPrivilege                          (7L)
#define SeSecurityPrivilege                     (8L)
#define SeTakeOwnershipPrivilege                (9L)
#define SeLoadDriverPrivilege                   (10L)
#define SeSystemProfilePrivilege                (11L)
#define SeSystemtimePrivilege                   (12L)
#define SeProfileSingleProcessPrivilege         (13L)
#define SeIncreaseBasePriorityPrivilege         (14L)
#define SeCreatePagefilePrivilege               (15L)
#define SeCreatePermanentPrivilege              (16L)
#define SeBackupPrivilege                       (17L)
#define SeRestorePrivilege                      (18L)
#define SeShutdownPrivilege                     (19L)
#define SeDebugPrivilege                        (20L)
#define SeAuditPrivilege                        (21L)
#define SeSystemEnvironmentPrivilege            (22L)
#define SeChangeNotifyPrivilege                 (23L)
#define SeRemoteShutdownPrivilege               (24L)
#define SeUndockPrivilege                       (25L)
#define SeSyncAgentPrivilege                    (26L)
#define SeEnableDelegationPrivilege             (27L)
#define SeManageVolumePrivilege                 (28L)
#define SeImpersonatePrivilege                  (29L)
#define SeCreateGlobalPrivilege                 (30L)
#define SeTrustedCredManAccessPrivilege         (31L)
#define SeRelabelPrivilege                      (32L)
#define SeIncreaseWorkingSetPrivilege           (33L)
#define SeTimeZonePrivilege                     (34L)
#define SeCreateSymbolicLinkPrivilege           (35L)
#define SeDelegateSessionUserImpersonatePrivilege (36L)
#define SeMaxWellKnownPrivilege SeCreateSymbolicLinkPrivilege
...
#define RtlLdrHeap()            (NtCurrentPeb()->ProcessHeaps[0])
#define RtlProcessHeap()        (NtCurrentPeb()->ProcessHeap)
#define NtGetProcessBase()      (NtCurrentPeb()->ImageBaseAddress)
#define NtGetLastError()        (NtCurrentTeb()->LastErrorValue)
#define NtSetLastError(Err)     { NtCurrentTeb()->LastErrorValue = (ULONG)Err; };
#define NtGetProcessFileName()  ((PWSTR)((NtCurrentPeb()->ProcessParameters)->ImagePathName.Buffer))
#define NtWindowsRoot()         ((PWSTR)(&SharedUserData->NtSystemRoot))
...
#define LPTHREAD_START_ROUTINE PUSER_THREAD_START_ROUTINE
...
#define NT_HEADERS( ImageBase )             \
    (PIMAGE_NT_HEADERS) ((CHAR*)ImageBase + \
    ((PIMAGE_DOS_HEADER)ImageBase)->e_lfanew)

#define IMAGE_DIRECTORY_ENTRY_RVA( NtHeader, ImageDirectory )   \
    (ULONG) (((PIMAGE_NT_HEADERS)NtHeader)->OptionalHeader.DataDirectory[ImageDirectory].VirtualAddress)

#define IMAGE_DIRECTORY_ENTRY_SIZE( NtHeader, ImageDirectory )   \
    (ULONG) (((PIMAGE_NT_HEADERS)NtHeader)->OptionalHeader.DataDirectory[ImageDirectory].Size)
